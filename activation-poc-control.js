...
(function() {
    ...
    function initializeSuperSeymour() {
        // Step 1: Page dim (50ms)
        setTimeout(() => createPageDimmer(), 50);

        // Step 2: Control orb appears (100ms)
        setTimeout(() => createControlOrb(), 100);

        // Step 3: Quick scan animation (200ms) - just visual effect
    ...
    window.SuperSeymour.toggle = function() {
        const orb = document.querySelector('#superseymour-orb');
        const dimmer = document.querySelector('#superseymour-dimmer');
