...
javascript:(function(){
    ...
    const sources = [
        // Primary: Your production server
        'https://superseymour.com/activation-poc.js',

        // GitHub CDN (raw.githubusercontent.com)
        'https://raw.githubusercontent.com/markusallen/superseymour/main/activation-poc.js',

        // GitHub Pages (if you set up github.io)
        'https://markusallen.github.io/superseymour/activation-poc.js',

        // jsDelivr CDN (auto-mirrors GitHub)
        'https://cdn.jsdelivr.net/gh/markusallen/superseymour@main/activation-poc.js',

        // Cloudflare Pages (if you deploy there)
        'https://superseymour.pages.dev/activation-poc.js',

        // Statically CDN (another GitHub mirror)
        'https://cdn.statically.io/gh/markusallen/superseymour/main/activation-poc.js',

        // GitHack CDN (serves raw files from GitHub)
        'https://raw.githack.com/markusallen/superseymour/main/activation-poc.js',
